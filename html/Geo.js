...
var map = new mapboxgl.Map({
    container: 'map',
    center: [2.296839, 49.875417], //Le lien vers le centre de la map à afficher
    //Le liens vers la map de MapBox
    style: 'mapbox://styles/mapbox/satellite-v9',
    zoom: 15,
    maxBound: bounds
});

//On utilise les fonctions de GeoJSON avec MapBox.
                ...
                "data": {
                    ...
                    "features": [{
                        ...
                        "geometry": {
                            ...
                            "coordinates": [2.298617, 49.874164] //Les Coordonnées
                        }
                    },
                    // fin d'un point
                     {
